...
function addRecipesToDocument(recipes) {
	...
	const elementInMain = document.querySelector('main');
	...
	recipes.forEach(recipe => {
		...
		elementInMain.appendChild(recipe_card);
	});
}
...
function initFormHandler() {
	...
	clear_button.addEventListener('click', function() {
        ...
        while (elementMain.firstChild) {
            elementMain.removeChild(elementMain.firstChild);
        }		
	});
}
